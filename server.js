...
import openGRRoutes from "./routes/OpenGR.js";
...
cron.schedule("* * 1 * *", () => {
  ...
  const openGRDir = dirCheckFiles("./fileUploads/SAP/DEVQAS_GRIR/DOWNLOAD/IN");
...
app.use("/openGR/generate", openGRRoutes);
